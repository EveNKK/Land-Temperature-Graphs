...
# Define UI
ui <- fluidPage(
  titlePanel("Average Temperature by State"),
  
  sidebarLayout(
    sidebarPanel("Select a year, month, and country to view.",
                 ...
                 #Year selection box
                  selectInput("SelectYear", h3("Year"),
                             ...
                             choices = list("2013 (January-August)" = "2013",
                                            ...
                                            "1901" = "1901",
                                            "1900" = "1900"
                                            #so many years... there's got to be a better way to code this
                                            ),
                             selected = "2012"),
                 
                 #Month selection box
                 selectInput("SelectMonth", h3("Month"),
                 ...
                 selectInput("SelectCountry", h3("Country"),
...
server <- function(input, output) {
  ...
  output$TempGraph <- renderPlot({
    ...
    #Sort and search data by selected year, month, and country 
    Data=Data[order(Data$Country),]
    Data2=subset(Data,Country==input$SelectCountry)
    Data3=subset(Data2,Month==input$SelectMonth)
    Data4=subset(Data3,Year==input$SelectYear)
      
    #Create graph from data
    ggplot(Data4,aes(x=AverageTemperature,y=State, color=AverageTemperature))+geom_point()
